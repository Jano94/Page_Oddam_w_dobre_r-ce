...
import ArticleColWG from "./article_columns_WG";
import {NavLink} from "react-router-dom";
import {Element} from "react-scroll"

const ArticleWhatGoing = () => {
        ...
        <>
            <Element name="articleWhatGoing" className="container section-what-going">
                ...
                <article className="row article-what-going">
                    ...
                    <div className="col-2">
                <ArticleColWG img={shirt} alt={"t-shirt"} title={"Wybierz rzeczy"}
                              text={"ubrania, zabawki, sprzęt i inne"}/>
                    </div>
                    <div className="col-2">
                <ArticleColWG img={box} alt={"package box"} title={"Spakuj je"}
                              text={"skorzystaj z worków na śmieci"}/>
                    </div>
                    <div className="col-2">
                <ArticleColWG img={loop} alt={"loop"} title={"Zdecyduj komu chcesz pomóc"}
                              text={"wybierz zaufane miejsce"}/>
                    </div>
                    <div className="col-2">
                <ArticleColWG img={arrows} alt={"loading arrows"} title={"Zamów kuriera"}
...
export default ArticleWhatGoing;